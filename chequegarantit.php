        ...
        <div class="main-panel">
          <div class="content-wrapper"style="text-align: -webkit-center;text-align-last: left;">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Chèques De Garantie Payés</h4>
<br>
                </p>
...
if (isset($_POST['search'])) {
    ...
    $stmt=$conn->query("SELECT * FROM Cheques   WHERE ((`assur`  LIKE '%$recherche%') OR (`ncheq`  LIKE '%$recherche%') OR (`typeC`  LIKE '%$recherche%')OR (`dateC`  LIKE '%$recherche%')) and etat='valide' and typeC='garantie'  ");
  ...
  while($row =$stmt->fetch())  {
    ...
    <td >".$row['prixch']."</td>
    <td >".$row['dateC']."</td>
      <td ><a href=","chequeupg.php?ncheq=".$row['ncheq']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
      <i class='mdi mdi-account-edit mdi-account'></i>
        </a>
        <a href=","chequedelg.php?ncheq=".$row['ncheq']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
  ...
  $stmt=$conn->query("select * from cheques  where etat='valide' and typeC='garantie'  ");
  echo"  <table class=","table table-striped",">
      <thead>
        <tr>
          <th> N°Cheque </th>
