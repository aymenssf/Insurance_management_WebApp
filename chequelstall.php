        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
           ...
           <div class="search-field d-none d-md-block">
            <form  method="POST" class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                <div class="input-group-prepend bg-transparent">
                  <button type="submit" name="search" class="input-group-text border-0 mdi mdi-magnify"style="font-size: larger;"></button>
                </div>
                <input type="search" name="searchh" class="form-control bg-transparent border-0" placeholder="Chercher Un cheque">
              </div>
            </form>
          </div>
        ...
        <div class="main-panel">
          <div class="content-wrapper"style="text-align: -webkit-center;text-align-last: left;">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Liste Des Chèques</h4>
                  <a href="chequeimpfltr.php"><button type="button" class='btn btn-gradient-primary btn-sm'>Filtrer Les Chèques  </button>
                    </a><br>
                </p>
...
if (isset($_POST['search'])) {
    ...
    $stmt=$conn->query("SELECT * FROM Cheques  WHERE ((`assur`  LIKE '%$recherche%') OR (`ncheq`  LIKE '%$recherche%') OR (`typeC`  LIKE '%$recherche%')OR (`dateC`  LIKE '%$recherche%')) and etat='non valide' ");
  ...
  while($row =$stmt->fetch())  {
    ...
    <td >".$row['typeC']."</td>
    <td >".$row['dateC']."</td>
      <td ><a href=","chequeup.php?ncheq=".$row['ncheq']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
      <i class='mdi mdi-account-edit mdi-account'></i>
        </a>
        <a href=","chequedel.php?ncheq=".$row['ncheq']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
      <i class='mdi mdi-trash-can-outline '></i>
      
        </a>
        <a href=","chequepymt.php","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
  ...
  $stmt=$conn->query("select * from cheques  where etat='non valide' ");
  echo"  <table class=","table table-striped",">
      <thead>
        <tr>
          <th> N°Cheque </th>
...
while($row =$stmt->fetch())  {
  ...
  <tr>     
    ...
    <i class='mdi mdi-trash-can-outline '></i>
      ...
      <a href=","chequepymt.php?ncheq=".$row['ncheq']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
      <i class='mdi mdi-comment-check-outline '></i>
