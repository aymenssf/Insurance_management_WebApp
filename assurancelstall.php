           ...
           <div class="search-field d-none d-md-block">
            <form  method="POST" class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                ...
                <input type="search" name="searchh" class="form-control bg-transparent border-0" placeholder="Chercher Une Assurance">
              </div>
            </form>
          </div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="assurancefiltre.php"><button type="button" class='btn btn-gradient-primary btn-sm'>Filtrer Les Assurances  </button>
                    </a>
...
if (isset($_POST['search'])) {
    ...
    $stmt=$conn->query("SELECT * FROM assurance join client on client.ndoss=assurance.ndoss  WHERE (`asr`  LIKE '%$recherche%') OR (`police`  LIKE '%$recherche%') OR (`type`  LIKE '%$recherche%') OR (`dateD`  LIKE '%$recherche%') OR (`dateF`  LIKE '%$recherche%') ");
  ...
  $stmt=$conn->query("select * from assurance join client on client.ndoss=assurance.ndoss");
  echo"  <table class=","table table-striped",">
      <thead>
      <tr>
      <th> Police </th>
