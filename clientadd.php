...
$pass=$_POST['pass'];
 ...
 $result= $conn->query("INSERT INTO `client` (`ndoss`, `asr`, `tel`, `pass`) 
    VALUES ('".$ndoss."', '".$asr."','".$tel."','".$pass."');"); 
}
?> 
<!DOCTYPE html>
<html lang="en">
...
<br>
                    <form class="forms-sample"  method="POST">
                      <div class="form-group">
                        <label>Assuré</label>
                        <input type="text" class="form-control" name="asr"  placeholder="Nom Et Prénom">
                      </div>
                      <div class="form-group">
                        <label>Numéro De Dossier</label>
                        <input type="text" class="form-control" name="ndoss"  placeholder="Numéro De Dossier">
                      </div>
                      <div class="form-group">
                      ...
                      <a href="clientlst.php" class="btn btn-light">Retour</a>
                    </form>
                  </div>
                </div>
              </div>            
