          ...
          <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
           ...
           <form  method="POST" class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                ...
                <input type="search" name="searchh" class="form-control bg-transparent border-0" placeholder="Chercher Un Client">
              </div>
            </form>
          </div>  
...
$stmt=$conn->query("SELECT * FROM client  WHERE (`ndoss`  LIKE '%$recherche%') OR (`tel`  LIKE '%$recherche%') OR (`asr`  LIKE '%$recherche%') ");
 ...
 while($row =$stmt->fetch(PDO::FETCH_NUM))  {
                ...
                <tr>     
                  ...
                  <i class='mdi mdi-trash-can-outline '></i>
                    ...
                    <td><a href=","clientdispassr.php?ndoss=".$row['0']."","><button type=","button"," class='btn btn-gradient-primary btn-sm'>Voir Assurances</button>
                    </a></td>
                </tr>
                        </tbody>";
 }
 ...
 while($row =$stmt->fetch(PDO::FETCH_NUM))  {
                ...
                <tr>     
                  ...
                  <i class='mdi mdi-account-edit mdi-account'></i>
                    ...
                    <a href=","clientdel.php?ndoss=".$row['0']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
                  <i class='mdi mdi-trash-can-outline '></i>
                    </a></td>
                    <td><a href=","clientdispassr.php?ndoss=".$row['0']."","><button type=","button"," class='btn btn-gradient-primary btn-sm'>Voir Assurances</button>
                    </a></td>
