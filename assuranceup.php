...
if (isset($_POST['submit'])) {
  $police=$_GET['police'];
    ...
    $dateD=$_POST['dateD'];
    $dateF=$_POST['dateF'];
$reponse = $conn->query("UPDATE `assurance` SET `type`='".$type."',`prix`='".$prix."',
`dateD`='".$dateD."',`dateF`='".$dateF."'
 WHERE  `assurance`.`police` = '".$police."';"); 
}
?> 
<?php
require "db_conn.php";
$police=$_GET['police'];
 $stmt=$conn->query("select * from ASSURANCE where police='".$police."' ");
...
<br>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Montant</label>
                        <input type="text" class="form-control" name="prix"  placeholder="Montant" value="<?php echo $prix?> ">
                      </div>
                      <div class="form-group">
                        <label>Date Debut</label>
                        <input type="text" class="form-control" name="dateD"  placeholder="Date Debut" value="<?php echo $dateD?> ">
                      </div>
                      <div class="form-group">
                        <label>Date Fin</label>
                        <input type="text" class="form-control" name="dateF"  placeholder="Date Fin" value="<?php echo $dateF?> ">
                      </div>
