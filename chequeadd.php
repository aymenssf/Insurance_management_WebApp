...
$dateC=$_POST['dateC'];
$typeC=$_POST['typeC'];
$result= $conn->query("INSERT INTO `cheques` (`ncheq`, `assur`, `prixch`,`dateC`,`typeC`,`etat`) 
VALUES ('".$ncheq."','".$assur."','".$prixch."','".$dateC."','".$typeC."','non valide');");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="main-panel">
          <div class="content-wrapper"style="text-align: -webkit-center;text-align-last: left;">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajouter Un Chèque</h4>
<br>
                    <form class="forms-sample"  method="POST">
                      <div class="form-group">
                        <label>Numero de chèque</label>
                        <input type="text" class="form-control" name="ncheq"  placeholder="Numero de cheque">
                      </div>
                      <div class="form-group">
                        <label>Assuré</label>
                        <input type="text" class="form-control" name="assur"  placeholder="Assuré">
                      </div>
    
                      <div class="form-group">
                        <label>Montant</label>
                        <input type="text" class="form-control" name="prixch"  placeholder="Montant">
                      </div>
                      <div class="form-group">
                        <label>Date D'échéance</label>
                        <input type="date" class="form-control" name="dateC"  placeholder="Date D'échéance">
                      </div>
                      <div class="form-group">
                      Type: <select class=" btn-sm  " name="typeC" 
                      style="color: #005db8;
    border-color: #005db8;"
 ><br>
  <option >Garantie</option>
  <option >À verser</option>
