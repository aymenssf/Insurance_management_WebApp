              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Clients <i class="mdi mdi-account-group-outline menu-icon mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?php
require "db_conn.php";
$result= $conn->query("SELECT * FROM client");
printf( $result->rowCount());
?></h2>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Assurances <i class="mdi mdi-shield menu-icon mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?php
require "db_conn.php";
$result= $conn->query("SELECT * FROM assurance");
printf( $result->rowCount());
?></h2>
                  </div>
                </div>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Chèques <i class="mdi mdi-cash menu-icon mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?php
require "db_conn.php";
$result= $conn->query("SELECT * FROM cheques");
printf( $result->rowCount());
?></h2>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Assurances Récentes</h4>
                    <div class="table-responsive">
                    <?php
$stmt=$conn->query("SELECT * from assurance join client on client.ndoss=assurance.ndoss ORDER BY datef ASC LIMIT 3");
