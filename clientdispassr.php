            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="assuranceadd.php?ndoss=<?php echo $_GET['ndoss']; ?>"><button type="button" class='btn btn-gradient-primary btn-sm'>Ajouter Une Assurance  </button>
                    </a>
<br>
                </p>
...
<?php
$ndoss=$_GET['ndoss'];
$stmt=$conn->query("select * from assurance  where ndoss='".$ndoss."'");
 ...
 while($row =$stmt->fetch())  {
                ...
                <tr>     
                  ...
                  <td >".$row['dateF']."</td>
                  <td >
                  <a href=","assuranceup.php?police=".$row['police']."&ndoss=".$_GET['ndoss']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
                  <i class='mdi mdi-account-edit '></i>
                    </a>
                    <a href=","assurancedel.php?police=".$row['police']."&ndoss=".$_GET['ndoss']."","><button type=","button"," class='btn btn-outline-secondary btn-rounded btn-icon'>
