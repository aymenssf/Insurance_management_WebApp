        ...
        <div class="main-panel">
          <div class="content-wrapper"style="text-align: -webkit-center;text-align-last: left;">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Liste Des Assurances Filtrées</h4>
<br>
                </p>
...
if (isset($_POST['submit'])) {
    $date1=$_POST['date1'];
    $date2=$_POST['date2'];
$stmt=$conn->query("select * from assurance join client on client.ndoss=assurance.ndoss WHERE dateF between '".$date1."' and '".$date2."' ORDER BY dateF ASC ");
echo "<a href=","imprimerr.php?&date1=".$date1."&date2=".$date2."","><button type=","button"," class='btn btn-gradient-primary btn-sm'>Télécharger/Imprimer</button></a>";  
