...
$date1=$_POST['date1'];
$date2=$_POST['date2'];
$result = $conn->query("select * from assurance join client WHERE dateF between '".$date1."' and '".$date2."' ORDER BY dateF ASC ");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="main-panel">
          <div class="content-wrapper"style="text-align: -webkit-center;text-align-last: left;">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Filtrer Les Assurances</h4>
<br>
                    <form class="forms-sample" action="filtre.php"  method="POST" >
                      <div class="form-group">
                        <label>Date N°1</label>
                        <input type="date" class="form-control" name="date1" >
                      </div>
                      <div class="form-group">
                        <label>Date N°2</label>
                        <input type="date" class="form-control" name="date2" >
                      </div>
                      <button  type="submit" class="btn btn-gradient-primary me-2" name="submit"  >Filter</button>
                      <a href="assurancelstall.php" class="btn btn-light">Retour</a>
                      </button>
                    </form>
                  </div>
                </div>
